...
def trigger_scan(collection: str, name: str) -> dict:
    ...
    """
    console_warning(f"Purview scan trigger is a placeholder - '{name}' in collection '{collection}'")
    logger.info(f"Placeholder: Triggering scan '{name}' in collection '{collection}' at {PURVIEW_ENDPOINT}")
