...
class ConsoleOutput:
    ...
    def __init__(self, use_colors: bool = True, use_emojis: bool = True, json_output: bool = False):
        """
    ...
    def _print_formatted(self, message: str, level: OutputLevel):
        ...
        stream = sys.stderr if level in [OutputLevel.ERROR, OutputLevel.CRITICAL] else sys.stdout
