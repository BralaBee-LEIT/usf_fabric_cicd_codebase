...
class WorkspaceManager:
    ...
    def __init__(self, environment: Optional[str] = None):
        ...
        logger.info(f"WorkspaceManager initialized for environment: {self.environment or 'all'}")
        ...
        **kwargs
        ...
        for attempt in range(retry_count):
            try:
                ...
                if response.status_code in [500, 502, 503] and attempt < retry_count - 1:
        ...
        if include_details:
            for workspace in workspaces:
                try:
                    ...
                    logger.warning(f"Could not fetch details for workspace {workspace['id']}: {e}")
    ...
    def add_user(
        ...
        try:
            ...
            if e.response.status_code == 409:
                ...
                raise ValueError(f"User '{principal_id}' already has access to workspace")
            raise
    ...
    def remove_user(self, workspace_id: str, principal_id: str) -> bool:
        ...
        try:
            ...
            if e.response.status_code == 404:
                logger.warning(f"User '{principal_id}' not found in workspace {workspace_id}")
                return False
            raise
    ...
    def create_workspace_set(
        ...
        for env in environments:
            ...
            try:
                ...
                logger.info(f"✓ Created {env} workspace: {workspace.get('displayName')}")
    ...
    def copy_users_between_workspaces(
        ...
        for user in source_users:
            ...
            target_role = role_mapping.get(principal_id, current_role) if role_mapping else current_role
