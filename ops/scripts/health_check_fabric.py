...
class FabricHealthChecker:
    ...
    def _check_workspace_accessibility(self):
        ...
        try:
            ...
            workspace_info = fabric_client._make_request('GET', f'workspaces/{self.workspace_id}')
    ...
    def _check_individual_item_health(self, item: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            item_id = item['id']
            item_details = fabric_client._make_request('GET', f'workspaces/{self.workspace_id}/items/{item_id}')
    ...
    def _check_git_integration_status(self):
        ...
        try:
            ...
            git_status = fabric_client._make_request('GET', f'workspaces/{self.workspace_id}/git/status')
...
def main():
    parser = argparse.ArgumentParser(description="Check Microsoft Fabric workspace health")
    parser.add_argument("--workspace", required=True, help="Fabric workspace name")
    parser.add_argument("--environment", required=True, help="Environment (dev/test/prod)")
