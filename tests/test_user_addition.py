...
test_payloads = [
    {
        ...
        "payload": {"emailAddress": user_email, "groupUserAccessRight": "Admin"},
    },
    {
    ...
    },
    {
        ...
        "payload": {"emailAddress": user_email, "workspaceRole": "Admin"},
    },
]
...
print("\n" + "=" * 70)
print(
    "If all fail, we may need to use Microsoft Graph API to get the user's Object ID first"
)
