...
def main():
    ...
    print(f"  4. Create PR: gh pr create --base main --head feature/customer_insights/{ticket}")
    print("\nCleanup (when done):")
    print("  • Delete workspace in Fabric portal")
    print(f"  • Delete branch: git push origin --delete feature/customer_insights/{ticket}")
    print()
